...
+
For more information about integration with SIEM tools, see the RHACS help documentation on link:https://docs.openshift.com/acs/3.73/welcome/index.html#integrating-with-other-products[external tools^].
+
